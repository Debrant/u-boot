...
static iomux_v3_cfg_t const ext_gpios_pads[] = {
	MX6_PAD_ENET2_RX_DATA0__GPIO2_IO08 | MUX_PAD_CTRL(GPI_PAD_CTRL),
...
static iomux_v3_cfg_t const usdhc2_pads[] = {
	...
	MX6_PAD_CSI_DATA04__USDHC2_DATA0 | MUX_PAD_CTRL(USDHC_PAD_CTRL),
	MX6_PAD_CSI_DATA05__USDHC2_DATA1 | MUX_PAD_CTRL(USDHC_PAD_CTRL),
	MX6_PAD_CSI_DATA06__USDHC2_DATA2 | MUX_PAD_CTRL(USDHC_PAD_CTRL),
	MX6_PAD_CSI_DATA07__USDHC2_DATA3 | MUX_PAD_CTRL(USDHC_PAD_CTRL),
};
...
static iomux_v3_cfg_t const fec1_pads[] = {
	...
	/*
	 * GPIO1_26 is used as PHY reset in TIGER6 v1 
	 */
	MX6_PAD_UART_CTS_B__GPIO1_IO26 | MUX_PAD_CTRL(ENET_PAD_CTRL),
};
...
void reset_phy(void)
{
	...
	*/
	/* CPU GPIO1_26 is connected to PHY reset */
	int reset = imx_gpio_nr(1, 26);
